        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="owl-features owl-carousel">
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('images/featured-01.jpg') }}" alt="" style="border-radius: 20px;">
              ...
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('images/featured-02.jpg') }}" alt="" style="border-radius: 20px;">
                  <div class="hover-effect">
                    <div class="content">
              ...
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('images/featured-03') }}.jpg" alt="" style="border-radius: 20px;">
                  <div class="hover-effect">
                    <div class="content">
              ...
              <div class="item">
                <div class="thumb">
                  <img src="{{ url('images/featured-04.jpg') }}" alt="" style="border-radius: 20px;">
                  <div class="hover-effect">
                    <div class="content">
